...
#load data
train_x_d = pd.read_csv('dataset/borrower_credit/train_x_discretization.csv')
train_x_nd = pd.read_csv('dataset/borrower_credit/train_x_nd.csv')
...
test_x_d = pd.read_csv('dataset/borrower_credit/test_x_discretization.csv')
test_x_nd = pd.read_csv('dataset/borrower_credit/test_x_nd.csv')
