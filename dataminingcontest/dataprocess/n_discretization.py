...
train_x = pd.read_csv('dataset/borrower_credit/train_x_discretization.csv')
test_x = pd.read_csv('dataset/borrower_credit/test_x_discretization.csv')
train_unlabeled_x =  pd.read_csv('dataset/borrower_credit/train_unlabeled_discretization.csv')
...
train_x[['uid','n1','n2','n3','n4','n5','n6','n7','n8','n9','n10']].to_csv('dataset/borrower_credit/train_x_nd.csv',index=None)
...
test_x[['uid','n1','n2','n3','n4','n5','n6','n7','n8','n9','n10']].to_csv('dataset/borrower_credit/test_x_nd.csv',index=None)
...
train_unlabeled_x[['uid','n1','n2','n3','n4','n5','n6','n7','n8','n9','n10']].to_csv('dataset/borrower_credit/train_unlabeled_nd.csv',index=None)
