...
train_x = pd.read_csv("dataset\\borrower_credit\\train_x.csv")
test_x = pd.read_csv("dataset\\borrower_credit\\test_x.csv")
train_unlabeled =  pd.read_csv("dataset\\borrower_credit\\train_unlabeled.csv")
...
train_x[['uid','n_null','discret_null']].to_csv('dataset/borrower_credit/train_x_null.csv',index=None)
...
test_x[['uid','n_null','discret_null']].to_csv('dataset/borrower_credit/test_x_null.csv',index=None)
...
train_unlabeled[['uid','n_null','discret_null']].to_csv('dataset/borrower_credit/train_unlabeled_null.csv',index=None)
