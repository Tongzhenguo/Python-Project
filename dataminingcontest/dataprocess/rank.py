...
feature_type = pd.read_csv('dataset/borrower_credit/features_type.csv')
...
test = pd.read_csv('dataset/borrower_credit/test_x.csv')[['uid']+numeric_feature]
test_rank = pd.DataFrame(test.uid,columns=['uid'])
for feature in numeric_feature:
    test_rank['r'+feature] = test[feature].rank(method='max')
test_rank.to_csv('dataset/borrower_credit/test_x_rank.csv',index=None)


train = pd.read_csv('dataset/borrower_credit/train_x.csv')[['uid']+numeric_feature]
train_rank = pd.DataFrame(train.uid,columns=['uid'])
for feature in numeric_feature:
    train_rank['r'+feature] = train[feature].rank(method='max')
train_rank.to_csv('dataset/borrower_credit/train_x_rank.csv',index=None)


train_unlabeled = pd.read_csv('dataset/borrower_credit/train_unlabeled.csv')[['uid']+numeric_feature]
...
train_unlabeled_rank.to_csv('dataset/borrower_credit/train_unlabeled_rank.csv',index=None)
