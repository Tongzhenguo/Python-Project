...
train = pd.read_csv("dataset/borrower_credit/train_x_rank.csv")
train_x = train.drop(['uid'],axis=1)
test = pd.read_csv("dataset/borrower_credit/test_x_rank.csv")
test_x = test.drop(['uid'],axis=1)
train_unlabeled =  pd.read_csv("dataset/borrower_credit/train_unlabeled_rank.csv")
...
train_x.to_csv('dataset/borrower_credit/train_x_discretization.csv',index=None)
...
train_unlabeled_x.to_csv('dataset/borrower_credit/train_unlabeled_discretization.csv',index=None)
...
test_x['uid'] = test.uid
test_x.to_csv('dataset/borrower_credit/test_x_discretization.csv',index=None)
